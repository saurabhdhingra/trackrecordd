...
class _CreateExerciseState extends State<CreateExercise> {
      ...
      body: SafeArea(
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: height * 0.01),
            muscleSelector(width, height, muscles, context),
          ],
        ),
      ),
    );
  ...
  Padding muscleSelector(width, height, List<String> muscles, BuildContext context) {
    return Padding(
            padding:
                EdgeInsets.symmetric(horizontal: width * 0.053, vertical: 16),
            child: Platform.isIOS
                ...
                : DropdownButton<String>(
                    ...
                    onChanged: (value) {
                      int intValue =
                          value == null ? 0 : muscles.indexOf(value);
                      setState(() {
  ...
  Padding nameInput(width) {
    return Padding(
            padding:
                EdgeInsets.symmetric(horizontal: width * 0.07, vertical: 16),
            child: Form(
              key: _formKey,
              child: TextFormField(
